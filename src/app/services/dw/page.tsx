        ...
        <section className="body-font">
            <div className="container px-5 py-12 mx-auto">
                <div className="text-center mb-20">
                    <h1 className="sm:text-3xl text-2xl font-medium text-center title-font text-white mb-4">Desenvolvimento Web</h1>
                    <p className="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto">Transforme suas ideias em realidade digital com sites responsivos, otimizados para desempenho e usabilidade excepcionais.</p>
                </div>
                    ...
                    <div className="p-4 lg:w-2/4 sm:w-1/2 w-full">
                        ...
                        <nav className="flex flex-col sm:items-start sm:text-left items-center -mb-1 space-y-2">
                            <a>
                                ...
                                </span>Transformação de ideias em sites responsivos e otimizados.
                            </a>
                            <a>
                                <span className="bg-gray-800 text-red-400 w-4 h-4 mr-2 rounded-full inline-flex items-center justify-center">
                                    <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="3" className="w-3 h-3" viewBox="0 0 24 24">
                                ...
                                </span>Melhoria da presença online e da experiência do usuário.
                            </a>
                            <a>
                                <span className="bg-gray-800 text-red-400 w-4 h-4 mr-2 rounded-full inline-flex items-center justify-center">
                                    <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="3" className="w-3 h-3" viewBox="0 0 24 24">
                                ...
                                </span>Personalização de acordo com as necessidades específicas do cliente.
                            </a>
                        </nav>
                    </div>
                    <div className="p-4 lg:w-2/4 sm:w-1/2 w-full">
                        ...
                        <nav className="flex flex-col sm:items-start sm:text-left  items-center -mb-1 space-y-2">
                            <a>
                                ...
                                </span>Desenvolvimento de sites dinâmicos e interativos.
                            </a>
                            <a>
                                <span className="bg-gray-800 text-red-400 w-4 h-4 mr-2 rounded-full inline-flex items-center justify-center">
                                    <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="3" className="w-3 h-3" viewBox="0 0 24 24">
                                ...
                                </span>Implementação de design responsivo para compatibilidade com dispositivos móveis.
                            </a>
                            <a>
                                <span className="bg-gray-800 text-red-400 w-4 h-4 mr-2 rounded-full inline-flex items-center justify-center">
                                    <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="3" className="w-3 h-3" viewBox="0 0 24 24">
                                ...
                                </span>Integração de tecnologias modernas para desempenho e segurança aprimorados.
                            </a>
                        </nav>
                    </div>
                </div>
                            ...
                            <div className="sm:w-1/2 mb-10 px-4" key={item.id}>
                                ...
                                <div className="flex gap-4 my-3">
                                    ...
                                    {!item.githublink && !item.deploylink && (
                                        <Link href={item.previa} className="text-tertiary mt-4 inline-flex items-center transition-transform hover:translate-x-2" target="_blank">Prévia
                                        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-4 h-4 ml-2" viewBox="0 0 24 24">
                                            <path d="M5 12h14M12 5l7 7-7 7"></path>
                                        </svg>
                                    </Link>
