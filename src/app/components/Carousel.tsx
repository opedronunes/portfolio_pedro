            ...
            >
                <SwiperSlide>
                    <div className="border border-green-600 rounded-md p-2 flex items-center justify-center text-center flex-col gap-4 text-gray-500 h-full">
                        <Layout size={32} className="text-4xl text-green-600"/>
                        <h4 className="text-green-600 font-bold text-2xl">Landing Pages</h4>
                ...
                <SwiperSlide>
                    <div className="border border-green-600 rounded-md p-2 flex items-center justify-center text-center flex-col gap-4 text-gray-500 h-full">
                        <Database size={32} className="text-4xl text-green-600"/>
                        <h4 className="text-green-600 font-bold text-2xl">Banco de dados</h4>
