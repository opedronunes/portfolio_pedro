                    ...
                    <div className="flex flex-col items-center gap-4 md:flex-row">
                        ...
                        <div className="flex flex-col gap-2 text-gray-200">
                            ...
                            <div className="flex justify-center gap-3 md:justify-start">
                                ...
                                <Link href="/projects" className="transition-colors hover:text-tertiary">
                                    Ver mais
                                </Link>
                            </div>
                            <div className="flex justify-start w-full gap-2 my-3">
                                <Link href="https://wa.me/5561996681439" className="w-full justify-center animate-pulse inline-flex px-6 py-2 text-lg text-gray-200 transition-colors border rounded focus:outline-none bg-tertiary border-tertiary" target="_blank">Contratar</Link>
                            </div>
                        </div>
                    </div>
