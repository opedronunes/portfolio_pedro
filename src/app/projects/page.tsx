    ...
    return (
        <div className="container px-2 mx-auto">
            <div className="divide-x-[1px] divide-gray-400 flex justify-end my-4">
                <Link className="p-1 text-gray-300 font-medium hover:text-tertiary transition-colors" title="Ir para" href={"/"}>Home</Link>
                <Link className="p-1 text-gray-300 font-medium hover:text-tertiary transition-colors" title="Ir para" href={"/contacts"}>Contato</Link>
            </div>
            <div>
